...
public class Cooler {
	...
	public String toString() {
		return "Cooler [coolerNo=" + coolerNo + ", coolerName=" + coolerName + ", companyName=" + companyName
				+ ", coolerKind=" + coolerKind + ", coolerSize=" + coolerSize + ", price=" + price + ", quantity="
				+ quantity + ", coolerImageNo=" + coolerImageNo + ", memo=" + memo + ", updateDate=" + updateDate + "]";
	}
	...
	public String getCoolerKind() {
		return coolerKind;
	}
	public void setCoolerKind(String coolerKind) {
		this.coolerKind = coolerKind;
	}
