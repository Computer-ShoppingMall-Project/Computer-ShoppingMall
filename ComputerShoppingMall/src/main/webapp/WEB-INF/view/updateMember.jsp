      ...
      <div>
         <table class="table">
            ...
            <tr>
               <td>우편번호 수정</td>
               <td>
                  <input type="text" id="zipcode" name="zipCode" value="${requestScope.customer.zipCode}" readonly="readonly" onclick="execDaumPostcode()" >
               </td>
            </tr>
            <tr>
               <td>도로명주소 수정</td>
               <td>
                  <input style="width:300px;" type="text" id="roadAddress" readonly="readonly" name="roadAddress" value="${requestScope.customer.roadAddress}" required>
               </td>
            </tr>
            <tr>
               <td>상세 주소 수정</td>
