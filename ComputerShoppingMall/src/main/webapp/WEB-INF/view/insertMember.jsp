			...
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					...
					<ul class="check">
						...
						<li><a href="#">Limitless page templates (15+ custom
								pages)</a></li>
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					...
					<form id="registerform" method="post" name="registerform"
						...
						<div class="form-group">
							<!-- 4자이상 : blur이벤트 발생시 체크 -->
							<input type="text" id="id" name="customerId" class="form-control"
								placeholder="ID"> <span id="idHelper" class="helper"></span>
						</div>
						<div class="form-group">
							<input type="password" id="pw" name="customerPw1"
								class="form-control" placeholder="Password"> <span
								id="pwHelper" class="helper"></span>
						</div>
						<div class="form-group">
							<input type="password" id="pwConfirm" name="customerPw2"
								class="form-control" placeholder="Re-enter password">
						</div>
						<div class="form-group">
							<input type="text" id="name" name="name" class="form-control"
								placeholder="Name"> <span id="nameHelper" class="helper"></span>
						</div>
						<div class="form-group">
							<input type="text" id="nickname" name="nickName"
								class="form-control" placeholder="Nickname"> <span
								id="nicknameHelper" class="helper"></span>
						</div>
						<div class="form-group">
							<input type="email" id="email" name="email" class="form-control"
								placeholder="Email"> <span id="emailHelper"
								class="helper"></span>
						</div>
						<div class="form-group">
							<input type="number" id="phone" name="phone" class="form-control"
								placeholder="Phone number"> <span id="phoneHelper"
								class="helper"></span>
						</div>
						<div class="form-group">
							<input type="number" id="zipcode" name="zipCode"
								readonly="readonly" onclick="execDaumPostcode()"
								class="form-control" placeholder="zip code"> <span
								id="zipcodeHelper" class="helper"></span>
						</div>
						<div class="form-group">
							<input type="text" id="roadAddress" readonly="readonly"
								name="roadAddress" class="form-control"
								placeholder="Road address"> <span id="roadHelper"
								class="helper"></span>
						</div>
						<div class="form-group">
							<input type="text" id="detailAddress" name="detailAddress"
								class="form-control" placeholder="Detail address"> <span
								id="detailHelper" class="helper"></span>
						</div>
						<div class="form-group">
