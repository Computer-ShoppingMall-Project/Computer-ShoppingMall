					...
					<div class="col-lg-3 col-md-3 col-sm-12">
						<div class="theme_details">
							<div class="details_section">
								<h3>Item Details</h3>
								<ul>
									<li class="version">Size: <span>11.8” X 7.87” X
											1.57</span></li>
									<li class="release">Release Date: <span>28
											February, 2014</span></li>
						...
						<div class="theme_details">
							...
							<div class="buttons">
								<a class="button btn-block large"
									href="${pageContext.request.contextPath}/SingleProductUpdateController">UPDATE</a>
								<a class="button btn-block large"
									href="${pageContext.request.contextPath}/SingleProductDeleteController">DELETE</a>
							</div>
							<!-- buttons -->
							<hr>
