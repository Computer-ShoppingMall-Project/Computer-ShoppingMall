			...
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				<div class="col-lg-6 col-md-6 col-sm-6">
					...
					<form class="contact-form php-mail-form" role="form"
						...
						<div class="sent-message">Your question has been sent. Thank
							you!</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					...
					<div class="form-group">
						<textarea class="form-control text-center" name="qnaAnswer"
							id="qnaAnswer" rows="5" data-rule="required"
							data-msg="Please write something message" readonly="readonly">Your answer is not registered</textarea>
						<div class="validate"></div>
					</div>
