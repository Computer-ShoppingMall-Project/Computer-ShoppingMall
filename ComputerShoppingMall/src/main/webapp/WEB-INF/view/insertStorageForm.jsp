		...
		<div class="container clearfix">
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					...
					<form id="insertStorageform" method="post" name="insertStorageform"
						action="${pageContextrequest.contextPath}/InsertStorageController">
						...
						<div class="form-group">
							<input type='radio' name='storageInterface' value='SATA3'
								onclick="clickCheck(this)" />SATA3 <input type='radio'
								name='storageInterface' value='PCIe4.0x4'
								onclick="clickCheck(this)" />PCIe4.0x4
						</div>
						<div class="form-group">
