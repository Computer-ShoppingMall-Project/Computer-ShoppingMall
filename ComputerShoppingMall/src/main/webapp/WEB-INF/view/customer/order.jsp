			...
			<form id="personalinfo" action="" name="personalinfo" method="post">
				...
				<div>
					<div class="col-lg-1 col-md-4 col-sm-12">
						...
						<input type="text" name="zipCode" id="zipcode" class="form-control" value="${requestScope.customer.zipCode}" class="form-control">
						<span id="zipcodeHelper" class="helper"></span>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
						<label for="lname">도로명 주소</label>
