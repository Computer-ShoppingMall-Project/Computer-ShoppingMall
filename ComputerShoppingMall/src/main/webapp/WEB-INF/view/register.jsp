			...
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					...
					<form id="registerform" method="post" name="registerform"
						action="<%=request.getContextPath()%>/InsertMemberController">
						<div class="form-group">
							<input type="text" name="customerId" class="form-control"
								placeholder="ID">
						</div>
						<div class="form-group">
							<input type="password" name="customerPw1" class="form-control"
								placeholder="Password">
						</div>
						<div class="form-group">
							<input type="password" name="customerPw2" class="form-control"
						...
						<div class="form-group">
							<input type="number" name="addressId" class="form-control"
								placeholder="Address">
						</div>
						<div class="form-group">
