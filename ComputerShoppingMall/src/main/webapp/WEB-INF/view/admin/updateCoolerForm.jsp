        ...
        <div class="search-bar">
          <form action="" method="get">
            <fieldset>
              ...
              <input type="text" class="${pageContext.request.contextPath}/search_text showtextback" name="s" id="s" value="Search..." />
            </fieldset>
          </form>
        </div>
        <!-- / end div .search-bar -->
    ...
    <div class="container clearfix">
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
         ...
         <form id="updateCoolerform" method="post" name="updateCoolerform" action="${pageContextrequest.contextPath}/UpdateCoolerController">
