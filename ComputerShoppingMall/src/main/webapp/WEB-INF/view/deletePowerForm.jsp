		...
		<div class="container clearfix">
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					...
					<form id="updatePowerform" method="post" name="updatePowerform"
						action="${pageContextrequest.contextPath}/UdatePowerController">
						<div class="form-group">
							<input type="number" readonly name="powerNo" class="form-control"
								placeholder="PowerNo">
						</div>
						<div class="form-group">
							<input type="text" readonly name="powerName" class="form-control"
								placeholder="PowerName">
						</div>
						<div class="form-group">
							<select class="readonly" name="ratedPower"
						...
						<div class="form-group">
							<input type="file" name="powerImage" class="form-control"
								placeholder="Img">
						</div>
						<div class="form-group">
