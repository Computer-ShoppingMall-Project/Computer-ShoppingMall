				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					...
					<form id="insertCoolerform" method="post" name="insertCoolerform"
						...
						<div class="form-group">
							<input type="number" readonly name="coolerNo"
								class="form-control" placeholder="CoolerNo">
						</div>
						<div class="form-group">
							<input type="text" readonly name="coolerName"
								class="form-control" placeholder="CoolerName">
						</div>
						<div class="form-group">
							<input type="text" readonly name="companyName"
						...
						<div class="form-group">
							<input type="number" readonly name="coolerSize"
								class="form-control" placeholder="CoolerSize">
						</div>
						<div class="form-group">
