		...
		<div class="container clearfix">
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					...
					<form id="deleteMainboardform" method="post"
						action="${pageContextrequest.contextPath}/DeleteMainboardController">
						<div class="form-group">
							<input type="number" readonly name="mainboardNo"
								class="form-control" placeholder="mainboardNo">
						</div>
						<div class="form-group">
							<input type="text" readonly name="mainboardName"
								class="form-control" placeholder="mainboardName">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type='radio' name='ramVersion' value='DDR4'
								onclick="return(false);" />DDR4 <input type='radio'
								name='ramVersion' value='DDR5' onclick="return(false);" />DDR5
						</div>
						<div class="form-group">
							<input type="text" readonly name="chipSet" class="form-control"
								placeholder="Chipset">
						</div>
						<div class="form-group">
							<input type="file" name="mainboardImage" class="form-control"
								placeholder="Img">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="textarea" readonly name="memo" class="form-control"
								placeholder="Memo">
						</div>
						<div class="form-group">
