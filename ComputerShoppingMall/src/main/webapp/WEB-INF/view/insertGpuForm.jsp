		...
		<div class="container clearfix">
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					...
					<form id="insertGpuform" method="post" name="insertGpuform"
						action="${pageContextrequest.contextPath}/InsertGpuController">
						...
						<div class="form-group">
							<input type="text" name="gpuSize" class="form-control"
								placeholder="GpuSize">
						</div>
						<div class="form-group">
