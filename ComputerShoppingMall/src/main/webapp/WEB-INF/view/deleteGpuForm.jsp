      ...
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
         ...
         <form id="deleteGpuform" method="post" name="deleteGpuform" action="${pageContextrequest.contextPath}/DeleteGpuController">
             ...
             <div class="form-group">
              <input type='radio' name='chipSetCompany' value='NVDIA'onclick="clickCheck(this)"/>NVDIA
			  <input type='radio' name='chipSetCompany' value='라데온'onclick="clickCheck(this)"/>라데온
            </div>
            <div class="form-group">
