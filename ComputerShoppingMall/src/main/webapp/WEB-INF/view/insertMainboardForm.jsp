		...
		<div class="container clearfix">
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					...
					<form id="insertMainBoardform" method="post"
						action="${pageContextrequest.contextPath}/InsertMainboardController">
						<div class="form-group">
							<input type="text" name="mainboardName" class="form-control"
								placeholder="mainboardName">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type='radio' name='ramVersion' value='DDR4'
								onclick="clickCheck(this)" />DDR4 <input type='radio'
								name='ramVersion' value='DDR5' onclick="clickCheck(this)" />DDR5
						</div>
						<div class="form-group">
