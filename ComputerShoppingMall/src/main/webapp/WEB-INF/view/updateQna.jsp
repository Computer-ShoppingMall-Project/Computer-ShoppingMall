		...
		<div class="container clearfix">
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				<div class="col-lg-6 col-md-6 col-sm-6 center-block"
					...
					<!-- QNA 리스트로 돌아가기 -->
					<a
						href="${pageContext.request.contextPath}/QnaOneController?qnaNo=${requestScope.qna.qnaNo}">back</a>

					<!-- 고객문의 수정 폼 -->
					<h4 class="title">Update QNA</h4>
					<form id="updateQnaForm" class="contact-form" role="form"
						action="${pageContext.request.contextPath}/UpdateQnaController?qnaNo=${requestScope.qna.qnaNo}"
						method="POST">
						...
						<div class="form-group">
							<input type="text" name="qnaTitle" class="form-control"
								id="qnaTitle" value="${requestScope.qna.qnaTitle}"
								placeholder="QNA title" data-rule="required">
						</div>
						<div class="form-group">
							<textarea class="form-control" name="qnaContent" id="qnaContent"
								placeholder="Contact Message" rows="5" data-rule="required">${requestScope.qna.qnaContent}</textarea>
						</div>
						<div class="form-send">
