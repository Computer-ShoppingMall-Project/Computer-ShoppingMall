    ...
    <div class="container clearfix">
      ...
      <form>
         <table class="table table-bordered">
            ...
            <tr>
               <th class="bg-info text-center">KIND</th> <!-- socketSize -->
               <td>
              ...
              <div class="he-wrap tpl6 market-item">
                ...
                <div class="he-view">
                  <div class="bg a0" data-animate="fadeIn">
                    ...
                    <a href="${pageContext.request.contextPath}/CartAddRamController?cpuNo=${c.ramNo}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-search">Detail</i></a>
                    <a href="${pageContext.request.contextPath}/CartAddRamController?" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-cart-plus">Add</i></a>
