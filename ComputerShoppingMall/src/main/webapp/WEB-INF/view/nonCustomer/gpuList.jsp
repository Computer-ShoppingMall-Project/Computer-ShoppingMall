										...
										<div class="he-view">
											<div class="bg a0" data-animate="fadeIn">
												<h3 class="big a1" data-animate="fadeInDown"></h3>
													<c:choose>
														<c:when test="${sessionAdminId != null }">
															<a href="${pageContext.request.contextPath}/UpdateGpuController?gpuNo=${c.gpuNo}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-plus">Update</i></a>
															<a hidden="hidden" style="display: none;" id="btnDel" href="${pageContext.request.contextPath}/DeleteGpuController?gpuNo=${c.gpuNo}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-minus">Delete</i></a>
