            ...
            <tr>
               ...
               <td>
                  <c:forEach var="c" items="${gpuSizeList}">
                     <input type="checkbox" name="core" value="${c}"><span>&nbsp;${c}&nbsp;</span>
                  </c:forEach>
               </td>
            </tr>
         </table>
              ...
              <div class="he-wrap tpl6 market-item">
                ...
                <div class="he-view">
                  <div class="bg a0" data-animate="fadeIn">
                    ...
                    <a href="${pageContext.request.contextPath}/CartAddGpuController?cpuNo=${c.gpuNo}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-search">Detail</i></a>
                    <a href="${pageContext.request.contextPath}/CartAddGpuController?" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-cart-plus">Add</i></a>
