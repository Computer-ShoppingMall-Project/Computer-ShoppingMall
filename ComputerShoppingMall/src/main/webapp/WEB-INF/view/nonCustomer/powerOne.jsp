						...
						<!-- theme_details -->
							...
							<div class="form-group">
								...
								<br>
									...
									<br>
									<div class="text-center">
										<form id="frm" class="contact-form"  action="${pageContext.request.contextPath}/CartAddPowerController?powerNo=${requestScope.powerOne.powerNo}" method="POST">
											개수 선택 &nbsp; <input type="number" min="1" max="${requestScope.powerOne.quantity}" name="quantity" value="1" class="text-center ">
