				...
				<div class="portfolio-centered">
					<div class="recentitems portfolio">
						<div class="recentitems portfolio isotope"
							...
							<c:forEach var="c" items="${powerList}" varStatus="s">
								<div
												...
												<h3 class="big a1" data-animate="fadeInDown"></h3>
													<c:choose>
														<c:when test="${sessionAdminId != null }">
															...
															<a hidden="hidden" style="display: none;" class="btn" href="${pageContext.request.contextPath}/DeletePowerController?powerNo=${c.powerNo}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-minus">Delete</i></a>
														...
														<c:otherwise>
															<a href="${pageContext.request.contextPath}/CartAddPowerController?powerNo=${c.powerNo}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-search">Detail</i></a> 
															<a hidden="hidden" style="display: none;" class="btn" href="${pageContext.request.contextPath}/MyBasketController?productNumber=${c.powerNo}&&productName=${c.powerName}&&price=${c.price}&&categoryName=${c.categoryName}&&campanyName=${c.companyName}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-cart-plus">Add</i></a>
