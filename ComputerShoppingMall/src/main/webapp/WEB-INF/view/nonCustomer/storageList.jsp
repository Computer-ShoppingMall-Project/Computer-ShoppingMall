		...
		<div class="container clearfix">
				...
				<form method="post" action="${pageContext.request.contextPath}/StorageListController">
					...
					<div>
						<c:if test="${sessionAdminId != null}">
							<a href="${pageContext.request.contextPath}/InsertStorageController" class="button" style="background-color: LightSkyBlue;" ><i class="fa fa-plus"></i>SSD/HDD 등록</a>
						</c:if>
			...
			<div class="portfolio-centered">
				...
				<div class="recentitems portfolio isotope" style="position: relative; overflow: hidden; height: 764px;">
					<c:forEach var="c" items="${storageList}" varStatus="s">
									...
									<div class="he-view">
										<div class="bg a0" data-animate="fadeIn">
											<h3 class="big a1" data-animate="fadeInDown"></h3>
													<c:choose>
														<c:when test="${sessionAdminId != null }">
															<a href="${pageContext.request.contextPath}/UpdateStorageController?storageNo=${c.storageNo}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-gear">Update</i></a>
															<a hidden="hidden" style="display: none;" class="btn" href="${pageContext.request.contextPath}/DeleteStorageController?storageNo=${c.storageNo}" class="dmbutton a2" data-animate="bounceInRight"></a>
														...
														<c:otherwise>
															<a href="${pageContext.request.contextPath}/CartAddStorageController?storageNo=${c.storageNo}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-search">Detail</i></a>
															<a hidden="hidden" style="display: none;" class="btn" href="${pageContext.request.contextPath}/MyBasketController?productNumber=${c.storageNo}&&productName=${c.storageName}&&price=${c.price}&&categoryName=${c.categoryName}&&campanyName=${c.companyName}" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-cart-plus">Add</i></a>
