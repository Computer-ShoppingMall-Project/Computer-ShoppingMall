			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				...
				<div class="search-bar">
					<form action="" method="get">
						<fieldset>
							<input type="${pageContext.request.contextPath}/image" src="img/pixel.gif" class="searchsubmit" alt="" />
									...
									<div class="he-wrap tpl6 market-item">
										...
										<div class="he-view">
											<div class="bg a0" data-animate="fadeIn">
												...
												<i class="fa fa-search"></i></a> <a href="#" class="dmbutton a2" data-animate="bounceInRight"><i class="fa fa-link"></i></a>
