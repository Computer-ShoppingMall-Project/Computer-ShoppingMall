		...
		<div class="container clearfix">
			<div class=" col-lg-12 col-md-12 col-sm-12 clearfix">
				...
				<nav class="portfolio-filter clearfix">
					<ul>
						<li><a
							href="${pageContext.request.contextPath}/CpuListController"
							class="dmbutton2" data-filter="*">CPU</a></li>
						<li><a
							href="${pageContext.request.contextPath}/MainboardListController"
							class="dmbutton2" data-filter=".mockups">MAINBOARD</a></li>
						<li><a
							href="${pageContext.request.contextPath}/RamListController"
							class="dmbutton2" data-filter=".graphic-design">RAM</a></li>
						<li><a
							href="${pageContext.request.contextPath}/GpuListController"
							class="dmbutton2" data-filter=".web-design">GPU</a></li>
						<li><a
							href="${pageContext.request.contextPath}/SsdListController"
							class="dmbutton2" data-filter="*">SSD</a></li>
						<li><a
							href="${pageContext.request.contextPath}/HhdListController"
							class="dmbutton2" data-filter=".mockups">HHD</a></li>
						<li><a
							href="${pageContext.request.contextPath}/CaseListController"
							class="dmbutton2" data-filter=".graphic-design">CASE</a></li>
						<li><a
							href="${pageContext.request.contextPath}/PowerListController"
							class="dmbutton2" data-filter=".web-design">POWER</a></li>
						<li><a
							href="${pageContext.request.contextPath}/CoolerListController"
							class="dmbutton2" data-filter=".web-design">COOLER</a></li>
					</ul>
				</nav>
				...
				<form>
					<table class="table table-bordered">
						<tr>
							...
							<td><c:forEach var="c" items="${cpuKindList}">
									<input type="checkbox" name="cpuKind" value="${c}">
									<span>${c}</span>
								</c:forEach></td>
						</tr>
						<tr>
							...
							<td><c:forEach var="c" items="${socketSizeList}">
									...
									<span class="ml_10 mr_10">${c}</span>
								</c:forEach></td>
						</tr>
						<tr>
							<th class="bg-info text-light  text-center">Core</th>
							<td><c:forEach var="c" items="${coreList}">
						...
						<tr>
							...
							<td><c:forEach var="c" items="${threadList}">
