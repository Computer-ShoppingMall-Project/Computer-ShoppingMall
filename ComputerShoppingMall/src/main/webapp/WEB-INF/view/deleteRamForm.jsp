		...
		<div class="container clearfix">
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					...
					<form id="insertCpuform" method="post" name="insertCpuform"
						action="${pageContextrequest.contextPath}/InsertCpuController">
						<div class="form-group">
							<input type="number" readonly name="cpuNo" class="form-control"
								placeholder="CpuNo">
						</div>
						<div class="form-group">
							<input type="text" readonly name="cpuName" class="form-control"
								placeholder="CpuName">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<select class="readonly" name="thread"
								onFocus="this.initialSelect = this.selectedIndex;"
								onChange="this.selectedIndex = this.initialSelect;">
						...
						<div class="form-group">
							<input type="file" name="cpuImage" class="form-control"
								placeholder="Img">
						</div>
						<div class="form-group">
