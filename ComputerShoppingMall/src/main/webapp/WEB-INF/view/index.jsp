					...
					<div class="services_lists">
						...
						<div class="services_lists_boxes clearfix">
							...
							<div class="col-lg-9 col-md-9 col-sm-9">
								...
								<p>Lorem Ipsum is simply dummy text of the industry. Lorem
	...
	<section class="section4 text-center">
		...
		<div class="portfolio-wrapper">
			<div id="owl-demo" class="owl-carousel">
				...
				<div class="item">
					<a data-rel="prettyPhoto" href="img/portfolio_01.jpg"> <img
						class="lazyOwl" src="img/portfolio_01.jpg"
						data-src="img/portfolio_01.jpg" alt="">
						<div>
				...
				<div class="item">
					<a data-rel="prettyPhoto" href="img/portfolio_02.jpg"> <img
						class="lazyOwl" src="img/portfolio_02.jpg"
				...
				<div class="item">
					<a href="single-portfolio-1.jsp"> <img class="lazyOwl"
						src="img/portfolio_07.jpg" data-src="img/portfolio_07.jpg" alt="">
						<div>
							<small>Product Design</small> <span>Project Name Here</span> <i
								class="fa fa-link"></i>
						</div>
				...
				<div class="item">
					<a href="single-portfolio-1.jsp"> <img class="lazyOwl"
						src="img/portfolio_05.jpg" data-src="img/portfolio_05.jpg" alt="">
						<div>
							<small>Product Design</small> <span>Project Name Here</span> <i
								class="fa fa-link"></i>
						</div>
				...
				<div class="item">
					<a data-rel="prettyPhoto" href="img/portfolio_09.jpg"> <img
						class="lazyOwl" src="img/portfolio_09.jpg"
						data-src="img/portfolio_09.jpg" alt="">
						<div>
							<small>Product Design</small> <span>Project Name Here</span> <i
								class="fa fa-search"></i>
						</div>
				...
				<div class="item">
					<a data-rel="prettyPhoto" href="img/portfolio_10.jpg"> <img
						class="lazyOwl" src="img/portfolio_10.jpg"
						data-src="img/portfolio_10.jpg" alt="">
						<div>
							<small>Product Design</small> <span>Project Name Here</span> <i
								class="fa fa-search"></i>
						</div>
				...
				<div class="item">
					<a data-rel="prettyPhoto" href="img/portfolio_06.jpg"> <img
						class="lazyOwl" src="img/portfolio_06.jpg"
						data-src="img/portfolio_06.jpg" alt="">
						<div>
							<small>Product Design</small> <span>Project Name Here</span> <i
								class="fa fa-search"></i>
						</div>
	...
	<section class="section2">
		<div class="container">
			<div class="message text-center">
				...
				<p class="small-title">Lorem Ipsum is simply dummy text of the
					printing and typesetting industy has been the industry"s standard.</p>
				<a class="button large" href="#">ABOUT OUR SERVICES</a> <a
					class=" dmbutton large" href="#">CONTACT US TODAY</a>
			</div>
			<!-- end message -->
		</div>
		<!-- end container -->
